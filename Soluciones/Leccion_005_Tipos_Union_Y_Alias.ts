...
type InputStrBool = boolean | string;

function recibirEntrada(input: InputStrBool): string {
  if (typeof input === "string") {
    return input.toUpperCase();
  }
  // Si no es un string, TypeScript sabe que es un boolean.
  // El operador ternario es un atajo para un if/else simple.
  return input ? "Usuario activo" : "Usuario inactivo";
}
