...
let arrayEjemplo: Usuario[] = [{id:1, nombre: "Pedro"}, {id:2, nombre: "Juan"}, {id:3, nombre:"Diego"}]

function encontrarUsuarioPorId(id:number): Usuario | undefined {
  return arrayEjemplo.find(usuario => usuario.id === id)
}
